---
title: Changelog
description: Complete version history and release notes for View Exports SVG
icon: clock-rotate-left
---

Track all changes, new features, enhancements, and bug fixes across all versions of View Exports SVG.
...
<Note type="info">
Due to VS Code security restrictions, it is currently not possible to directly obtain the file path on the OS for dropped files. As a workaround, the contents of dropped files are read and sent via `postMessage` to create a temporary file. For more details, see the [GitHub issue](https://github.com/microsoft/vscode/issues/255608).
</Note>
